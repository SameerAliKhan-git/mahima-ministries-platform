      ...
      <div className="flex gap-2">
        ...
        <div className="relative w-32">
          <button
            ...
            className={`w-full px-3 py-2.5 border ${error ? 'border-red-500' : 'border-gray-300'} rounded-lg bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-purple-500 transition-all flex items-center justify-between`}
          >
            <span className="flex items-center gap-2">
              ...
              />
              <span className="font-semibold text-gray-900">{selectedCountry.dialCode}</span>
            </span>
          ...
          {isOpen && (
            <>
              ...
              />
              <div className="absolute z-20 mt-1 w-80 bg-white border border-gray-200 rounded-lg shadow-lg max-h-96 overflow-hidden">
                {/* Search */}
                  ...
                  {filteredCountries.length > 0 ? (
                    filteredCountries.map((country) => (
                      ...
                      >
                        ...
                        <span className="text-sm font-semibold text-gray-700 flex-shrink-0">{country.dialCode}</span>
                      </button>
                    ))
                  ) : (
        ...
        <div className="flex-1">
          <input
            ...
            required={required}
            className={`w-full px-4 py-2.5 border ${error ? 'border-red-500' : 'border-gray-300'} rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all`}
          />
        </div>
      </div>
      {error && (
